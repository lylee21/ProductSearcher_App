...
const HomeScreen = ({ navigation }) => {
	...
	const Card = ({ plant }) => {
		return (
			<TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate("Details", plant)}>
		...
		<SafeAreaView style={{ flex: 1, paddingHorizontal: 20, backgroundColor: COLORS.white }}>
			<View style={style.header}>
				<View>
					...
					<Text style={{ fontSize: 38, color: COLORS.blue, fontWeight: "bold" }}>Product Searcher</Text>
				</View>
